...
// Pasamos la broma al VoiceRSS API

function cuentame(joke){

    VoiceRSS.speech({
        key: '21c2a7f250f8481fa613f07fb0443e70',
        src: joke,
        hl: 'es-MX',
        v: 'Linda',
        r: 0, 
...
// obtener la broma API

async function getJokes(){
    let joke = '';
    const apiURL = 'https://v2.jokeapi.dev/joke/Programming,Miscellaneous?lang=es&blacklistFlags=political';
